...
import { useLoginMutation } from '../../store/features/usersApiSlice';
...
const handleSubmit = async (e) => {
    ...
    try {
     ...
     dispatch(setCredentials({...res}))
      ...
      console.log( "login error : " +err?.data?.message || err.message);
    }
}
  return (
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-5">
              ...
              <div className="text-center">
                <p className="text-base text-gray-600">Don't have an account? <Link to={"/signup"}  className="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Sign Up</Link></p>
              </div>
            </div>
          </form>
        </div>
